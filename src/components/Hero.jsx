...
const Hero = () => {
  return (
    ...
    >
      <Helmet>
        <title>Nirpendra Nath Mishra Software Dev</title>
        <meta
          name="description"
          content="Hi, I'm Nirpendra Nath Mishra, a Full-Stack web developer passionate about creating innovative web solutions. Connect with me to discuss web development and explore my projects."
        />
        {/* Open Graph tags */}
        <meta property="og:title" content="Nirpendra Nath Mishra - Web Developer" />
        <meta
          property="og:description"
          content="Hi, I'm Nirpendra Nath Mishra, a web developer passionate about creating innovative web solutions. Connect with me to discuss web development and explore my projects."
        />
        <meta property="og:image" content={HeroImg} />
        <meta property="og:url" content="https://nirpendranathmishra.tech" />
        <meta property="og:type" content="website" />
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Nirpendra Nath Mishra - Web Developer" />
        <meta
          name="twitter:description"
          content="Hi, I'm Nirpendra Nath Mishra, a web developer passionate about creating innovative web solutions. Connect with me to discuss web development and explore my projects."
        />
        <meta name="twitter:image" content={HeroImg} />
        <meta name="twitter:url" content="nirpendranathmishra.tech" />
      </Helmet>
      ...
      <div className="self-img">
        <img className="w-[70vw] lg:w-96" src={HeroImg} alt="Nirpendra Nath Mishra" />
      </div>
    </motion.div>
  );
};
