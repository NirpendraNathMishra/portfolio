...
const Contact = () => {
  return (
    ...
    >
      <Helmet>
        <title>Contact Me - Nirpendra Nath Mishra</title>
        <meta
          name="description"
          content="Get in touch with Nirpendra Nath Mishra. Schedule a meeting, send a message, or reach out through various social media channels. Feel free to write an email directly to nirpendranathmishra1947@gmail.com"
        />
        <meta property="og:title" content="Contact Me - Nirpendra Nath Mishra" />
        <meta
          property="og:description"
          content="Get in touch with Nirpendra Nath Mishra. Schedule a meeting, send a message, or reach out through various social media channels. Feel free to write an email directly to nirpendranathmishra1947@gmail.com"
        />
        <meta property="og:image" content="https://nirpendranathmishra.tech/banner.png" />
        <meta property="og:url" content="https://nirpendranathmishra.tech/contact" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Contact Me - Nirpendra Nath Mishra" />
        <meta
        ...
        <div className="flex flex-col-reverse md:flex-row justify-around mt-10 w-[100%]">
          <div className="md:w-[50%] w-[100%]  my-16">
            <div className="text-white mb-16">
              ...
              <a href="https://cal.com/nirpendra-nath-mishra-rbrzft" target="_blank">
            ...
            <form
              action="https://getform.io/f/wbrkjpma"
              method="POST"
              target="_blank"
              onSubmit={""}
            >
