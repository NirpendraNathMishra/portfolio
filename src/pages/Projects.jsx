...
const Projects = () => {
  return (
    ...
    >
       <Helmet>
        <title>My Projects - Nirpendra Nath Mishra</title>
        <meta
          name="description"
          content="Explore a collection of projects developed by Nirpendra Nath Mishra. From web development to open source contributions, discover the diverse projects that showcase Nirpendra's skills and expertise."
        />
        {/* Open Graph tags */}
        <meta property="og:title" content="My Projects - Nirpendra Nath Mishra" />
        <meta
          property="og:description"
          content="Explore a collection of projects developed by Nirpendra Nath Mishra. From web development to Freelance projects, discover the diverse projects that showcase Nirpendra's skills and expertise."
        />
        <meta property="og:image" content="https://nirpendranathmishra.tech/banner.png" />
        <meta property="og:url" content="https://nirpendranathmishra.tech/projects" />

        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="My Projects - Nirpendra Nath Mishra" />
        <meta
